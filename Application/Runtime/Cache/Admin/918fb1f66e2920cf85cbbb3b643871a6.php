...
<a href="#" title="Sign Out"></a>
    ...
    <ul id="main-nav">
        ...
        <li><a href="/trainee/Admin/Project/addProject" class="nav-top-item  current">
            ...
            <ul>
                <li><a href="/trainee/Admin/Project/showProject"   class="current">项目列表</a></li>
                <li><a >基本信息</a>
                </li>
            </ul>
...
welcome！ <?php echo ($admininfo['admin_name']); ?>
</h2>


<ul class="shortcut-buttons-set">
<li><a class="shortcut-button"
href="/trainee/Admin/Project/addProject"><span> <img
...
<tbody>
<?php if(is_array($projects)): $i = 0; $__LIST__ = $projects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project): $mod = ($i % 2 );++$i;?><tr>

<td><input type="checkbox" name="check" value="<?php echo ($project['id']); ?>"/></td>

<td><?php echo ($project['pro_name']); ?>  </td>
<td><?php echo ($project['pro_time_start']); ?></td>
<td name="pro_end"><?php echo ($project['pro_time_end']); ?></td>
<td><?php echo ($project['pro_instruct']); ?></td>
<td>
<script>
...
<td><a
    href="/trainee/Admin/Project/showDetailProject/pro_id/<?php echo ($project['id']); ?>"
    title="Look"><img
    src="/trainee/Application/admin/Common/resources/images/icons/glass.png"
    alt="Look" height="18"></a> <a
    href="/trainee/Admin/Project/updateProject/pro_id/<?php echo ($project['id']); ?>"
    title="Edit"><img
    src="/trainee/Application/admin/Common/resources/images/icons/pencil.png"
    alt="Edit"/></a> <a
    href="/trainee/Admin/Project/delete/pro_id/<?php echo ($project['id']); ?>"
    title="Delete"><img
    src="/trainee/Application/admin/Common/resources/images/icons/cross.png"
    alt="Delete"/></a></td>
<td><a id="notconfirm/<?php echo ($project['id']); ?>" class="button"
   href="/trainee/Admin/Unit/showUnit/pro_id/<?php echo ($project['id']); ?>">查看</a>
</div>
<Script>
