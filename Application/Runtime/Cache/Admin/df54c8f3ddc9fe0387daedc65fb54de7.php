...
<script type="text/javascript" src="/trainee/Application/admin/Common/resources/scripts/myjs.js"></script>
...
<form action="/trainee/Admin/Unit/update/unit_id/<?php echo ($unit_id); ?>/pro_id/<?php echo ($pro_id); ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('id','','R','area','','R','cost','','R');return document.MM_returnValue">
...
<tr>
  ...
  <td width="272"><label>
    <input name="unit_name" type="text" id="type"
           value="<?php echo ($unit_info['unit_name']); ?>"
           placeholder=" * 为必填项"
           required
    />
*
  ...
  <td width="192"><label>
    <input name="unit_limit" type="text" id="docu_id"
           placeholder="请输入数字"
           value="<?php echo ($unit_info['unit_limit']); ?>"
...
<tr>
  ...
  <td width="172"><label>
    <input name="unit_user" type="text" id="type"
           value="<?php echo ($unit_info['unit_user']); ?>"
           placeholder=" * 为必填项"
           required
  ...
  <td width="192"><label>
    <input name="unit_pwd" type="text" id="docu_id"
           value="<?php echo ($unit_info['unit_pwd']); ?>"
           placeholder=" * 为必填项"
           required
    />
    *
  ...
  <td width="172"><label>
    <input name="repo_name" type="text" id="type"
           value="<?php echo ($unit_info['repo_name']); ?>"
           placeholder=" * 为必填项"
           required/>
    *
  </label></td>
  ...
  <td width="192"><label>
    <input name="repo_phone" type="text" id="repo_phone"
           value="<?php echo ($unit_info['repo_phone']); ?>"
  ...
  <td width="172"><label>
    <input name="repo_email" type="input" id="type"
           value="<?php echo ($unit_info['repo_email']); ?>"
           pattern="^[\w-]+(\.[\w-]+)*@[\w-]+(\.[\w-]+)+$"
           placeholder=" * 为必填项"
           required/>
    *
  ...
  <td width="192"><label>
    <input name="unit_zipcode" type="text" id="docu_id"
           value="<?php echo ($unit_info['unit_zipcode']); ?>"
           pattern = "[1-9][0-9]{5}";
           placeholder=" * 为必填项"
           required
    />
  ...
  <td width="172"><label>
    <input name="unit_address" type="text" id="type"
           value="<?php echo ($unit_info['unit_address']); ?>"
           placeholder=" * 为必填项"
           required/>
    *
  </label></td>
  ...
  <td width="192"><label>
  <textarea name="unit_remark" cols="" rows=""
  ><?php echo ($unit_info['unit_remark']); ?></textarea>
