			...
			<ul id="main-nav">
				...
				<li><a href="/trainee/Admin/Project/addProject" class="nav-top-item ">
					...
					<ul>
						...
						<li><a href="#"  onclick="alert()">基本信息</a></li>
					</ul>
				...
				<li><a href="/trainee/Admin/Project/addProject" class="nav-top-item current">设置 </a>
					<ul>
						<li><a href="/trainee/Admin/Admin/showAdmin">个人信息</a></li>
						<li><a href="/trainee/Admin/Admin/updatePwd" class="current">修改密码</a></li>
...
<form action="/trainee/Admin/Admin/comfirmPwd" method="post" name="form1" id="form1" onsubmit="MM_validateForm('id','','R','area','','R','cost','','R');return document.MM_returnValue">
<table width="400" height="160" border="3">
<tr>
<td width="14" ><span class="STYLE2"><div align="right">
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">原密码</p>
</span></td>
<td width="272"><label>
	<input name="old_pwd" type="password" id="type"
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">新密码</p>
</span></td>
<td width="272"><label>
	<input name="new_pwd" type="password" id="type"
	...
	<tr>
		<td width="114"><span class="STYLE2"><div align="right">
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">确认密码</p>
</span></td>
		<td width="272"><label>
			<input name="new_pwd" type="password" id="type"
