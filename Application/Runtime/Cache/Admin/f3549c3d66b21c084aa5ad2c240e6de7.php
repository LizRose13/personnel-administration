...
<h3 style="color: #0c0c0c" >学员列表</h3>
    ...
    <div align="right">
        ...
        <a class="button" href="/trainee/Admin/Trainee/expUser/unit_id/<?php echo ($unit_id); ?>">导出学员信息</a>
...
<table>
    ...
    <?php if(is_array($trainees)): $i = 0; $__LIST__ = $trainees;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$trainee): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <a href="/trainee/Admin/Trainee/showDetailTrainee/trainee_id/<?php echo ($trainee['id']); ?>" title="Look"><img src="/trainee/Application/admin/Common/resources/images/icons/glass.png" alt="Look" /></a>
                <a href="/trainee/Admin/Trainee/updateTrainee/trainee_id/<?php echo ($trainee['id']); ?>" title="Edit"><img
                        src="/trainee/Application/admin/Common/resources/images/icons/pencil.png"
                        alt="Edit"/></a>
                <a href="/trainee/Admin/Trainee/delete/trainee_id/<?php echo ($trainee['id']); ?>" title="Delete"><img
