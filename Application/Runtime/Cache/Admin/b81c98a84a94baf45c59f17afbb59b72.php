...
<table width="400" height="160" border="3">
  ...
  <tr>
    ...
    <td width="114"><span class="STYLE2"> <div align="right">
      <p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">是否显示在首页</p></span></td>
    <td width="95"><label>
      <select name="pro_isFirst" id="pro_isFirst">
        <option value="0">否</option>
        <option value="1" href="/trainee/Admin/Project/showProject">是</option>
   ...
   <tr>
     ...
     <td width="114"><span class="STYLE2"> <div align="right">
      ...
      <td width="92"><label>
        <input name="pro_remark" type="text" id="type"
