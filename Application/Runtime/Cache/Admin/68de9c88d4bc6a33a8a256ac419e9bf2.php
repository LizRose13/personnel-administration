		...
		<div id="sidebar-wrapper">
			...
			<ul id="main-nav">
				...
				<li><a href="/trainee/Admin/Project/addProject" class="nav-top-item current">设置 </a>
					<ul>
						<li><a href="/trainee/Admin/Admin/showAdmin" class="current">个人信息</a></li>
...
<h3 style="color: #0c0c0c">管理员信息</h3>
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">&#31649;&#29702;&#21592;id</p></span></td>
				<td width="272"><label>
					<input name="pro_name" type="text" id="type"
						   disabled="disabled"  value="<?php echo ($admininfo['id']); ?>"
					/>
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">用户名</p></span></td>
				<td width="272"><label>
					<input name="pro_name" type="text" id="type"
						disabled="true"   value="<?php echo ($admininfo['admin_name']); ?>"
					/>
