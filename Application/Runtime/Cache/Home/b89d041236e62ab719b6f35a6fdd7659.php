...
<!-- Sidebar Profile links -->
    ...
    <ul id="main-nav">
        ...
        <li><a href="/trainee/Admin/Project/addProject" class="nav-top-item current">
            ...
            单位信息</a>
            <ul>
                <li><a href="/trainee/Home/Unit/showUnit" class="current">单位详情</a></li>
    ...
    <div class="table-responsive">
        <table class="table">
            <tr>
                ...
                <td width="272"><?php echo ($unitinfo['unit_name']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">通讯员名称:</td>
                <td width="272"><?php echo ($unitinfo['repo_name']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">通讯员电话:</td>
                <td width="272"><?php echo ($unitinfo['repo_phone']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">通讯员email:</td>
                <td width="272"><?php echo ($unitinfo['repo_email']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">邮编:</td>
                <td width="272"><?php echo ($unitinfo['unit_zipcode']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">地址:</td>
                <td width="272"><?php echo ($unitinfo['unit_address']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">人数限制:</td>
                <td width="272"><?php echo ($unitinfo['unit_limit']); ?></td>
            </tr>

            <tr>
                <td width="72"></td>
                <td width="72"  class="attr_name">已报人数:</td>
                <td width="272"><?php echo ($unitinfo['unit_limit']); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td width="272"><?php echo ($unitinfo['unit_remark']); ?></td>
            </tr>
        </table>
    </div>
    <!-- /.table-responsive -->
