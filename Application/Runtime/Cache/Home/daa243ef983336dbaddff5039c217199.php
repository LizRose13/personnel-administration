...
<form action="/trainee/Home/Trainee/add" method="post" name="form1" id="form1" onsubmit="MM_validateForm('id','','R','area','','R','cost','','R');return document.MM_returnValue">
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">职务</p></span></td>
            ...
            <td width="192"><label>
                <input name="tra_job" type="text" id="docu_id"
                       placeholder=" * 为必填项"
                       required
                />
                *
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">移动电话</p></span></td>
            <td width="172"><label>
                <input name="tra_telephone" type="text" id="type"  required
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">固定电话</p></span></td>
            <td width="172"><label>
                <input name="tra_fixphone" type="text" id="type"  required
                       pattern="(\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$"
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">邮编	</p></span></td>
            <td width="172"><label>
                <input name="tra_zidcode" type="text" id="type"  required
                       placeholder=" * 为必填项"
                />
                *
            </label></td>
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">电子邮箱</p></span></td>
            <td width="172"><label>
                <input name="tra_email" type="text" id="type"  required
                       placeholder=" * 为必填项"
                       pattern="^[\w-]+(\.[\w-]+)*@[\w-]+(\.[\w-]+)+$"
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">地址</p></span></td>
            <td width="172"><label>
                <input name="tra_address" type="text" id="type"  required
                       placeholder=" * 为必填项"
                />
                *
            </label></td>
...
<p style="font-family:微软雅黑;color:#4bbd00;font-size:13px;">备注</p></span></td>
            <td width="172"><label>
                <input name="tra_remark" type="text" id="type"  required
                       placeholder=" * 为必填项"
                />
                *
            </label></td>
