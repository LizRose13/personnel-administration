...
<div id="login-wrapper" class="png_bg">
    <div id="login-top">
        ...
        <p   style="font-size: 45px" >干部管理系统</p>
        <p   style="font-size:25px"> <?php echo ($projectinfo['pro_name']); ?>  登陆</p>
        <!-- End #logn-top -->
        <div id="login-content">


            <form action="/trainee/Home/Index/loginin/pro_id/<?php echo ($projectinfo['id']); ?>" method="post">
                ...
                <p>
                    ...
                    <input  style="font-size: 15px" class="text-input" type="text" name="unit_user"/>
                </p>
                <div class="clear"></div>
                <p>
                    <label style="font-size: 18px;text-align: right">密码</label>
                    <input  style="font-size: 15px" class="text-input" type="password" name="unit_pwd" />
                </p>
