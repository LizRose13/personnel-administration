...
<ul>
    ...
    <li><a href="/trainee/Home/Unit/updateUnit" class="current" >修改密码</a></li>
...
<h3 style="color: #0c0c0c" class="attr_name">修改密码:</h3>
...
<form action="/trainee/Home/Unit/updatepassword" method="post" name="form1" id="form1" onsubmit="MM_validateForm('id','','R','area','','R','cost','','R');return document.MM_returnValue">

<table class="table">
<tr>
    <td width="72"></td>
    <td width="72" class="attr_name">旧密码:</td>
    <td width="272"><label>
        <input name="unit_pwd" type="password" id="type"
               placeholder=" * 为必填项"
               required
    ...
    <tr>
        <td width="72"></td>
        <td width="72" class="attr_name">新密码:</td>
        <td width="272"><label>
            <input name="new_pwd"
                   type="password"
                   placeholder=" * 为必填项"
    ...
    <tr>
        <td width="72"></td>
        <td width="72" class="attr_name">确认密码:
        </td>
        <td width="272"><label>
...
function validate() {
    ...
    var pwd1=document.getElementsByName("new_pwd")[0].value;
    var pwd2=document.getElementsByName("new_pwd_again")[0].value;

    if(pwd1==pwd2){
        document.getElementsByName("tishi")[0].innerHTML="两次输入密码相同";
        document.getElementsByName("submit").disabled=false;
    }else{
        document.getElementsByName("tishi")[0].innerHTML="两次密码不一致";
